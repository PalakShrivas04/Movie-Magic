  ...
  return (
      <Dialog PaperProps={{ style: { borderRadius: 20 } }} open={true}>
          ...
          <form onSubmit={handleSubmit}>
              <Box display={"flex"} padding={2.6}
                  justifyContent={'center'}
                  flexDirection={'column'} width={400} height={350}  margin="auto"
                  alignContent={"center"}>
                  ...
                  <TextField value={inputs.password} onChange={handleChange} margin="normal" variant="standard"type='password' name="password" />
                   ...
                   <Button sx={{ mt: 2, borderRadius: 10, bgcolor: "#04364A" }} type="submit" fullWidth variant="contained">
                      {isSignup ? "Signup" : "Login"}
                  </Button>
